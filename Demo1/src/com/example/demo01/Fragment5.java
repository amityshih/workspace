...
public class Fragment5 extends Fragment {
	...
	List<String> fund_type_ex = new ArrayList<String>();
	 ...
	 final Runnable mUpdateResults = new Runnable() {
        public void run() {
        	//ListView1.setItemChecked(position, value)
        	//ListView1.setSelection=   MainActv.f5FirstVisibleItem
	        ...
	        //goToListView(list_in,fund_type_in);
       	    //ListView1.scrollTo(0, (MainActv.f5FirstVisibleItem)*100)  ;
       	    //ListView1.smoothScrollToPosition((MainActv.f5FirstVisibleItem)*100);
       	    //ListView1.setSelection(MainActv.f5FirstVisibleItem);
            //ListView1.setItemChecked(MainActv.f5FirstVisibleItem, true);
            //ListView1 =(ListView) v.findViewById(R.id.ListView_detail);
            //ListView1.setSelection(MainActv.f5FirstVisibleItem);
       		//ListView1.setSelectionFromTop(MainActv.f5FirstVisibleItemPer, 0);    
       		ListView1.setSelection(MainActv.f5FirstVisibleItemPer);    
		    //Log.d("Amity Log", "MainActv.f5FirstVisibleItemPer = " +  MainActv.f5FirstVisibleItemPer);

        }
    };

/*	public static Fragment5 newInstance(String buttonClickItem) {
		Fragment5 f = new Fragment5();

        // Supply index input as an argument.
        Bundle args = new Bundle();
        args.putString("buttonClickItem", buttonClickItem);
        f.setArguments(args);
...
/*	@Override
	public void onSaveInstanceState(Bundle outState) {
	     ...
	     outState.putInt("buttonClickNum", buttonClickNum);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ListView1.setOnTouchListener(new OnTouchListener(){
            ...
            public boolean onTouch(View arg0, MotionEvent event) {
			    //Log.d("Amity Log", "getX + " +  event.getX());
			    //Log.d("Amity Log", "getY + " +  event.getY());
...
/*    	        switch(scrollState) { 
			    ...
			    //Log.d("Amity Log", "getScaleX + " +  absListView.getScaleX());
			    //Log.d("Amity Log", "getScaleY + " +  absListView.getScaleY());
			    //Log.d("Amity Log", "getX + " +  absListView.getX());
			    //Log.d("Amity Log", "getY + " +  absListView.getY());
			    //Log.d("Amity Log", "getScrollX + " +  absListView.getScrollX());
			    //Log.d("Amity Log", "getScrollY + " +  absListView.getScrollY());
			    //Log.d("Amity Log", "getSelectedItemPosition + " + absListView.getSelectedItemPosition());
    	    }
    	    
    	    @Override
    	    public void onScroll(AbsListView absListView, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
			    MainActv.f5FirstVisibleItem = firstVisibleItem;
			    //Log.d("Amity Log", "MainActv.f5FirstVisibleItem + " +  MainActv.f5FirstVisibleItem);
 ...
 /*   	              Log.i("OnScroll","Scroll");
    	        ...
    	        */  
    	        //Log.i("OnScroll","getScrollX:" + ListView1.setSelection(position)); 
    	        //Log.i("OnScroll","getScrollY:" + ListView1.getScrollY()); 
    	    }
    	});
