...
public class Fragment3 extends Fragment {
    ...
    public Fragment3 newInstance(String testString){
         Log.d("Amity Log", "Fragment3 newInstance");
    	//假如此Fragment需要接受參數才能運作, 則可在這裡要求傳入所有必須的參數
    	Fragment3 frag=new Fragment3();
 	   //產生一個Bundle
        Bundle b=new Bundle();
        //將所有需要的參數都打包到裡面
        b.putString("teststring", testString);
 	   //最後將這個Bundle設成Fragment的參數
        frag.setArguments(b);
        return frag;
     }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Log.d("Amity Log", "Fragment3 onCreate");
    }
